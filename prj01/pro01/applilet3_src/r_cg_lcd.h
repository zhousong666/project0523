...
#define _01_LCD_CLOCK_FSUB_FIL_2           (0x01U) /* fSUB/2^2 or fIL/2^2*/
#define _02_LCD_CLOCK_FSUB_FIL_3           (0x02U) /* fSUB/2^3 or fIL/2^3 */
#define _03_LCD_CLOCK_FSUB_FIL_4           (0x03U) /* fSUB/2^4 or fIL/2^4 */
