...
#define _00_TAU_CH5_TI05_INPUT                  (0x00U) /* input signal of the TI05 pin as a timer input */
...
void Card_initialization();//³õÊ¼»¯¿¨Æ¬
void Read_0_Page_block();
